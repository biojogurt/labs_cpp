...
std::list<double> modify(std::list<int>::iterator, std::list<int>::iterator);
std::list<double> modify_transform(std::list<int> &);
std::list<double> modify_transform(std::list<int>::iterator, std::list<int>::iterator);
std::list<double> modify_for_each(std::list<int> &);
std::list<double> modify_for_each(std::list<int>::iterator, std::list<int>::iterator);
int numbers_sum(const std::list<int> &);
int numbers_sum(std::list<int>::iterator, std::list<int>::iterator);
double numbers_average(const std::list<int> &);
double numbers_average(std::list<int>::iterator, std::list<int>::iterator);
template<class T>
...
std::list<double> modify_no_range(std::list<int> &, int);
std::list<double> display_modify_range(std::list<int> &, int);
